...
//			mesg.setFrom(ina);
		...
		File file1 = new File("E:/xczqdb.pptx");
		File file2 = new File("E:/三三.png");
		try {
...
//			attach2.setFileName("p1.png");
		...
		DataSource ds = new FileDataSource("E:/三三.png");
		...
		try {
			letterword.setContent("12312312<img src='cid:123'></img>","text/html;charset=utf-8");
		} catch (MessagingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
//		File wirteOut = new File("E:/IP1.msg");
